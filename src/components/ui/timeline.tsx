  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto py-20 px-4 md:px-8 lg:px-10 text-center">
        <motion.h2 
          className="text-lg md:text-5xl lg:text-6xl mb-6 font-bold mx-auto leading-tight"
        ...
        >
          <div className="h-1 w-24 bg-gradient-to-r from-primary via-orange-500 to-yellow-500 rounded-full shadow-lg" />
        </motion.div>
      </div>
